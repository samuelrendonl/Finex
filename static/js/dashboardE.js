...
function confirmAction(message) {
  ...
  if (!overlay) {
    ...
    overlay.innerHTML = '<div class="app-confirm-box"><h3>Confirmar acción</h3><p></p><div class="app-confirm-actions"><button type="button" class="secondary" data-confirm-cancel>Cancelar</button><button type="button" class="danger" data-confirm-accept>Aceptar</button></div></div>';
...
async function del(path, cb) {
  if (!(await confirmAction("¿Confirmas la eliminación?"))) return;
  try {
